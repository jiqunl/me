...
- **Liu, J.** & Shah, C. (2022). Leveraging user interaction signals and task state information in adaptively optmizing usefulness-oriented search sessions. In *Proceedings of ACM/IEEE Joint Conference on Digital Libraries.* Cologne, Germany. **(JCDL2022)**
