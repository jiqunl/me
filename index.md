...
- Chen, N., Fang, H., **Liu, J.**, Wei, W., Sakai, T., & Wu, X-M. (2026). Mitigating the threshold priming effect in large language model-based relevance judgments via personality simulation. In *Proceedings of the 19th ACM International Conference on Web Search and Data Mining*. Boise, Idaho. **(WSDM2026)**.
