### About Me
I am an **Assistant Professor of Data Science** at the University of Oklahoma (OU). I hold a PhD in Information Science from Rutgers iSchool. I currently work with my students at the [Human-Computer Interaction and Recommendation (HCIR) Lab](https://ouhcirgroup.github.io/) at OU. 

My research focuses on the intersection of human-computer interaction (HCI), interactive information seeking/retrieval, and cognitive psychology, and seeks to apply the knowledge learned about people interacting with information in adaptive recommendation, user education and intelligent nudging. My recent studies/projects include: 1) **Cognitive Psychology + Information Retrieval + Machine Learning**: investigating the impacts of users' cognitive states on their search decision-making and evaluations of information seeking/search episodes, with the ultimate goal of making intelligent systems more sensitive to human needs, biases and concerns; 2) **Bias-aware Adaptive Information System**: understanding user biases and bounded rationality that affect and contextualize human-information interaction and applying the knowledge about biases on both user and system sides in developing and evaluating adaptive, ethical system recommendations. My recent CV can be found at [here](https://drive.google.com/file/d/1VO86C0SqhAp2N65q3N3nrPn2QfWVvuia/view?usp=sharing). 
